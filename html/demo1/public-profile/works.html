...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/works" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/works" property="og:url"/>
        ...
        <div class="scrollable-x-auto">
         <div class="menu gap-3" data-menu="true">
          ...
          <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary active">
           <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/works.html">
          ...
          <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary">
           <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/teams.html">
            <span class="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
             Teams
            </span>
           </a>
          ...
          <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary">
           <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/network.html">
            <span class="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
             Network
            </span>
           </a>
          ...
          <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary">
           <a class="menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/activity.html">
            <span class="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
             Activity
            </span>
           </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
         <div class="card border-0">
          ...
          <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
           <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo1/public-profile/profiles/company.html">
            Urban Dreams
           </a>
           <div class="flex items-center justify-between grow">
            <div class="flex items-center grow">
             <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-6.png"/>
             <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo1/public-profile/profiles/nft.html">
              Cody Fisher
             </a>
            </div>
